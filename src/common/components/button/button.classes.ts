...
import { focusVisibleRingStyles, transitionStyles, disabledStyles } from '../../utils/styles';

export const buttonVariants = cva(
  `inline-flex items-center justify-center rounded-md font-medium ${transitionStyles} ${focusVisibleRingStyles} ${disabledStyles} disabled:shadow-none`,
  {
    variants: {
      variant: {
        primary:
